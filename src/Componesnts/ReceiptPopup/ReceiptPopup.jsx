...
const ReceiptPopup = ({ orderDetails, onClose, onPrint }) => {
  ...
  // ✅ Debug: See what data you're receiving
    console.log("📋 Receipt Order Details:", orderDetails);

    // ✅ Handle case when orderDetails is null/undefined
    if (!orderDetails) {
        return null;
    } 
  ...
  return (
    <div className="receipt-popup-overlay text-dark">
      <div className="receipt-popup">
        ...
        <p><strong>Phone:</strong> {orderDetails.phoneNumber || orderDetails.mobileNumber}</p>
