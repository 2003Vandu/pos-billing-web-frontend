...
import { featchDashboardData } from "../../Service/Dashboard";
...
const DashBoard = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const response = await featchDashboardData();
        setData(response.data);
      } catch (error) {
        console.error(error);
        toast.error("Something went wrong, unable to view data");
      } finally {
        setLoading(false);
      }
    };
